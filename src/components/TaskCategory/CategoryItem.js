...
const CategoryItem = ({categoryObject}) => {
    const categoryItemid = v4();

  return (
    <div className='p-1 flex items-center hover:bg-gray-100 rounded-md'>
        ...
        <div className='flex-grow relative z-0 mr-3'>
            ...
            <div className="bg-red-200 w-fit min-w-0 px-2 py-1 rounded-md">{categoryObject.title}</div>
        </div>
